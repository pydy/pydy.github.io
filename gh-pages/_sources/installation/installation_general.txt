...
packages.  We recommend using the latest version of SymPy that is available on
their `github repository <https://github.com/sympy/sympy>`_.

The other tools that you will likely want to install are
