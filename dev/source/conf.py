...
# -*- coding: utf-8 -*-
#
# PyDy documentation build configuration file, created by
...
latex_documents = [
  ('index', 'PyDy.tex', 'PyDy Documentation',
   'PyDy Team', 'manual'),
]
...
texinfo_documents = [
  ('index', 'PyDy', 'PyDy Documentation',
   'PyDy Team', 'PyDy', 'One line description of project.',
   'Miscellaneous'),
]
