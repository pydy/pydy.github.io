...
`http://effbot.org/zone/import-confusion.htm <http://effbot.org/zone/import-confusion.htm>`_.
...
frame by `beta` and create a vector in that new frame that is a function of
...
stiffness, `k`, to point, `no`. This means that a force...To be continued.
