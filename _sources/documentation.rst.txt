...
- `Symbolic Vectors [SymPy Docs] <https://docs.sympy.org/latest/explanation/modules/physics/vector/index.html>`_
- `Symbolic Dynamics [SymPy Docs] <https://docs.sympy.org/latest/explanation/modules/physics/mechanics/index.html>`_
...
<https://www.scipy-lectures.org/>`_ are a great intro to scientific computing
with Python. Finally, to learn about how to do symbolic manipulation with
SymPy, check out the `SymPy Documentation <https://docs.sympy.org>`_,
...
- `Symbolic Dynamics Examples <https://docs.sympy.org/latest/tutorials/physics/mechanics/index.html>`_
- `The PyDy Documentation Examples <https://pydy.readthedocs.io/en/stable/#examples>`_
